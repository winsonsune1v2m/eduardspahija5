...
class Binlog2sql(object):
    ...
    def process_binlog(self):
        ...
        with temp_open(tmp_file, "w") as f_tmp, self.connection as cursor:
            ...
            f_tmp.close()
            if self.flashback:
                return self.print_rollback_sql(filename=tmp_file)
        #return True
...
if __name__ == '__main__':
    ...
    args = command_line_args(['--flashback', '-h192.168.1.126', '-P3306', '-uroot', '-pmysql', '-dmtrops_v2', '-tN_test',
                              '--start-file=mysql-bin.000001', '--start-position=2554190', '--stop-position=2554403'])
